    ...
    render () {
        return(       
            ...
            <label className="card">
                <h1>Astuces</h1>
                <h2> Vous avez un problème ? Nos astuces peuvent peut-être vous aider. </h2>
            </label>
            <label className="titreactivite">ENT</label>
            ...
            <label className="titreactivite">Logiciel libre</label>
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                            <div id="Carousel1" className="carousel slide">
            ...
            <label className="titreactivite">Sécurité</label>
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                            <div id="Carousel1" className="carousel slide">
